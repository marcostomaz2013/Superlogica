...
<!-- plugins:css -->
<link rel="stylesheet" href="{{ asset('vendor/iconfonts/simple-line-icon/css/simple-line-icons.css') }}">
...
<link rel="stylesheet" href="{{ asset('vendor/iconfonts/ti-icons/css/themify-icons.css') }}">
